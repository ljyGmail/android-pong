...
public class Ball {
    ...
    void update(long fps) {
        // Move the ball based upon the horizontal (mXVelocity) and vertical (mYVelocity) speed
    ...
    void batBounce(RectF batPosition) {
        ...
        if (relativeIntersect < 0) {
            ...
            // Math.abs is a static method that strips any negative values form a value.
        ...
        // Having calculated left or right for horizontal direction simply reverse
        // the vertical direction to go back up the screen
        reverseYVelocity();
    }
}
