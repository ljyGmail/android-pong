...
public class PongGame extends SurfaceView implements Runnable {
    ...
    public PongGame(Context context, int x, int y) {
        // super calls the parent class constructor of SurfaceView
        // provided by Android
        super(context);
    ...
    private void draw() {
        if (mOurHolder.getSurface().isValid()) {
            ...
            // Display the drawing on screen unlockCanvasAndPost is a method of SufaceView
    ...
    // because we implemented Runnable interface
    ...
    public void run() {
        ...
        while (mPlaying) {
            ...
            // The movement has benn handled and collisions detected now
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction() & MotionEvent.ACTION_MASK) {
            // The play has put their finger on the screen
            case MotionEvent.ACTION_DOWN:
                // If the game was paused onpause
                mPaused = false;
            ...
            // We will use more complicated and robust touch handing
